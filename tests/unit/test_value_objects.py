"""Slice 0. The invariants that make each type a type, not the business rules over them.

Field rules such as CRM format, CID membership and leave period arithmetic arrive with slice 3.
"""
...
def test_evidence_rejects_empty_text() -> None:
    """Evidence citing nothing cannot be checked against the source text, so it is not evidence."""
