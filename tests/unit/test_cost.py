"""Spec 0007: the variable cost per document, measured by the evaluation and nowhere else."""
...
class CountingLlm(StubLlm):
    """The reference answers, each call with a known consumption."""
...
def test_aws_evaluation_reports_the_mean_variable_cost_of_analysed_documents(tmp_path):
    ...
    # a: one million input tokens is US$ 5.00. b: 100k output tokens is US$ 2.50, plus ten OCR
    # pages at US$ 0.0015. c is refused: it returns no consumption and stays out of the mean.
